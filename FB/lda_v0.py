# coding: utf-8
__author__ = 'Keguo: https://kaggle.com/keguoh'
...
def run_solution():
    ...
    train = np.genfromtxt('trn_cut.csv', dtype = "i8, f8, f8, i8, i8, S10", names = ['row_id', 'x', 'y', 'accuracy', 'time', 'place_id'], delimiter = ',', skip_header = 1)
    train
    # f = open("train_cut.csv", "r")
    # f.readline()
    # total = 0
    # grid_size_x = 285 #500
...
#     total_time = 
#     split_t = math.floor((1.0 - 0.23) * total_time)
